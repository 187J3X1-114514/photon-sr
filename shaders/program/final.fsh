...
void main() {
    ...
    fragment_color = is_sky
        ? vec3(1.0) : vec3(clamp01(dist * rcp(DISTANCE_VIEW_MAX_DISTANCE)));
    #endif
    ...
    #ifdef DEBUG_INFO
    begin_text(ivec2(gl_FragCoord.xy) / 3, ivec2(0, viewHeight / 3));
    text.fg_col = vec4(1.0, 1.0, 1.0, 1.0);
    text.bg_col = vec4(0.0, 0.0, 0.0, 0.5);
    print((_D, _e, _b, _u, _g, _space, _I, _n, _f, _o, _colon, _space));
    print_line();
    print((_J, _i, _t, _t, _e, _r, _space, _X, _colon, _space));
    print_float(MC_JITTER_OFFSET.x);
    print_line();
    print((_J, _i, _t, _t, _e, _r, _space, _Y, _colon, _space));
    print_float(MC_JITTER_OFFSET.y);
    print_line();
    print((_R, _e, _n, _d, _e, _r, _space, _S, _c, _a, _l, _e, _colon, _space));
    print_float(MC_RENDER_SCALE);
    print_line();
    print((_R, _e, _n, _d, _e, _r, _space, _R, _a, _t, _i, _o, _colon, _space));
    print_float(MC_RENDER_RATIO);
    print_line();
    print((_R, _e, _n, _d, _e, _r, _space, _S, _c, _a, _l, _e, _space, _L, _o, _g, _2, _colon, _space));
    print_float(MC_RENDER_SCALE_LOG2);
    print_line();
    print((_S, _c, _a, _l, _e, _d, _space, _V, _i, _e, _w, _p, _o, _r, _t, _space, _S, _i, _z, _e, _colon, _space));
    print_vec2(MC_SCALED_VIEWPORT_SIZE);
    print_line();
    print((_O, _r, _i, _g, _i, _n, _a, _l, _space, _V, _i, _e, _w, _p, _o, _r, _t, _space, _S, _i, _z, _e, _colon, _space));
    print_vec2(MC_ORIGINAL_VIEWPORT_SIZE);
    end_text(fragment_color);
    #endif
}
